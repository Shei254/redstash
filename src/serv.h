...
*/
#ifndef REDSTASH_SERVER_H_
#define REDSTASH_SERVER_H_

#include "include.h"
#include <map>
#include <vector>
#include <string>
#include "redstash/redstash_impl.h"
#include "redstash/ttl.h"
#include "backend_dump.h"
#include "backend_sync.h"
#include "slave.h"
#include "net/server.h"

class REDSTASHServer
{
private:
...
public:
	...
	REDSTASHServer(REDSTASH *redstash, REDSTASH *meta, const Config &conf, NetworkServer *net);
	~REDSTASHServer();
