...
void welcome(){
	printf("leveldb-import - Import existing leveldb into redstash\n");
	printf("Copyright (c) 2013-2015 redstash.io\n");
	printf("\n");
}
...
void usage(int argc, char **argv){
	...
	printf("\n");
	printf("Options:\n");
	printf("    ip - redstash server ip address\n");
	printf("    port - redstash server port number\n");
