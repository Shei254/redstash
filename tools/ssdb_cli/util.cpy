...
class REDSTASH_kv_scan extends REDSTASH_iterator_base
{
	public items = [];
...
/*
scan = new REDSTASH_kv_scan();
while(kvs.next()){
	print scan.key, scan.val;
}
*/

class REDSTASH_hash_list extends REDSTASH_iterator_base
{
	function init(link){
	}
...
class REDSTASH_zset_list extends REDSTASH_iterator_base
{
	function init(link){
	}
...
class REDSTASH_queue_list extends REDSTASH_iterator_base
{
	function init(link){
	}
...
class REDSTASH_hash_scan extends REDSTASH_iterator_base
{
	public name = '';
	public items = [];
...
class REDSTASH_zset_scan extends REDSTASH_iterator_base
{
	public name = '';
	public items = [];
...
class REDSTASH_queue_scan extends REDSTASH_iterator_base
{
	public items = [];
	public offset = 0;
...
/*
scan = new REDSTASH_queue_scan('q');
while(scan.next()){
	print scan.item;
}
*/
